...
The Windows app 2.4.4 deliverable is an **unsigned development** release. It is
...
The published version is [v2.4.4](https://github.com/ilyakichigin92/MBUprime-StructLab/releases/tag/v2.4.4).
The current source targets app 2.4.4, manifest schema 7, and scientific policy
...
- `dist\MBUprime-StructLab-2.4.4-windows-x64-unsigned.zip`
- `dist\MBUprime-StructLab-2.4.4-windows-x64-unsigned.zip.sha256`
- `dist\MBUprime-StructLab-2.4.4-windows-x64-unsigned.release-manifest.json`
...
Analyzed runs are a separate user-data format. App 2.4.4 writes deterministic
